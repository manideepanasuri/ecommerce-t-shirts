            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2">
                ...
                {userToken ? (
                  <>
                    ...
                    <Link
                      ...
                      className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
                    >
                      <i className="fa-fw  fas fas fa-tags"></i> Orders
                    </Link>
              ...
              <div>
                ...
                <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">
                  <a href="mailto:manideepanasuri@gmail.com">
                    manideepanasuri@gmail.com
                  </a>
                </span>
                <span className="block space-x-2 mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">
                  ...
                  <a
                    href="mailto:manideepanasuri@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  <a
                    href="https://leetcode.com/manideepanasuri1"
                    className="inline"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
